...
<head>
    ...
    <link rel="stylesheet" href="review/stylerecomment.css">
    <link
    ...
    <div class="container">
        <div class="content-container">
            <div class="featured-content"
                style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('review/img/anhtest.jpg');">
     ...
     <?php if($i < 6) {?>
        ...
        <td> <img src="../Admin/img/<?php echo $row["image"]; ?>" width = 200 title="<?php echo $row['image']; ?>"> </td>
                    ...
                    <div class="movie-list">
                        ...
                        <?php foreach ($rows as $row) :  ?>
                            ...
                            <div class="movie-list-item">
                                <img class="movie-list-item-img" src="../Admin/img/<?php echo $row["image"]; ?>" alt="">
